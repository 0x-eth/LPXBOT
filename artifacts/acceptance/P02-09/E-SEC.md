...
- Gitleaks 8.30.1 scanned 642 commits and approximately 20.59 MB of full history with no leaks. `pnpm audit:dependencies` reported no known vulnerabilities under Node 22.
