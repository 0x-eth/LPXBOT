...
Focused result: 8 P04-06 Vitest files / 39 tests passed, including the real Fastify preview/submit/get routes, ownership, replay, conflict, no-store, media type, password zeroization, strict browser response parsing, and no automatic submission retry.
