...
| `pnpm test` | 124 Vitest files / 749 tests and 128/128 governance tests passed |
...
| `gitleaks git --config=.gitleaks.toml --redact .` | 1,192 commits / 24.23 MB scanned; no leaks found |
