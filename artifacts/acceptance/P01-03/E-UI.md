...
- Mini App network failures return to an actionable login error and retry through the Mini App adapter; verifier 401 responses preserve their safe error code and message.
...
`pnpm test:e2e` passed 30 tests across:

- Chromium desktop at 1440 x 900.
- Chromium mobile at 390 x 844.
- Mini App keyboard activation and mobile viewport behavior.
- Mini App interrupted-request recovery through the method-specific retry control.
