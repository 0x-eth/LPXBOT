...
Gitleaks 8.30.1 scanned the complete 968-commit history and approximately 22.84 MB with no leaks. `pnpm audit:dependencies` reported no known vulnerabilities.
