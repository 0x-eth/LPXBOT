import{h as I,Q as l,n as m,j as P,k as A,y as v,N as p,l as c,H as z,E as B,R as $,z as F,$ as M,x as K,W as Q,r as W,i as q,ag as U}from"./AppKitProvider-nVcOIkXs.js";import{S as s}from"./SwapController-Cnyijf0d.js";import"./index-gpZK-9xy.js";import"./index-D0FmPqGc.js";import"./http-CqmYNlLj.js";import"./parseUnits-CN82zxnQ.js";const H={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),u=a==="a",D=a==="c",_=a==="v",j=a==="x",L=i===",",N=i===".",O=i>="0"&&i<="9";!r&&(u||D||_||j)&&e.preventDefault(),t==="0"&&!L&&!N&&i==="0"&&e.preventDefault(),t==="0"&&O&&(o(i),e.preventDefault()),(L||N)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!O&&!n.includes(i)&&!N&&!L&&e.preventDefault()}},G=I`
  :host {
    width: 100%;
  }
...
`;var V=function(e,t,o,n){var r=arguments.length,i=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var u=e.length-1;u>=0;u--)(a=e[u])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let E=class extends A{constructor(){super(...arguments),this.target="sourceToken"}render(){return c`
...
`;var T=function(e,t,o,n){var r=arguments.length,i=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var u=e.length-1;u>=0;u--)(a=e[u])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};const J=5e-5;let k=class extends A{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null,this.autoFocus=!1}firstUpdated(){this.autoFocus&&requestAnimationFrame(()=>{this.shadowRoot?.querySelector("input")?.focus()})}render(){const t=this.marketValue||"0",o=p.bigNumber(t).gt("0");return c`
      <wui-flex
    ...
    `:c` <wui-button
      ...
      >
        Select token
      </wui-button>`}tokenBalanceTemplate(){const t=p.multiply(this.balance,this.price),o=t?t?.gt(J):!1;return c`
...
`;var w=function(e,t,o,n){var r=arguments.length,i=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var u=e.length-1;u>=0;u--)(a=e[u])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let d=class extends A{subscribe({resetSwapState:t,initializeSwapState:o}){return()=>{v.subscribeKey("activeCaipNetwork",n=>this.onCaipNetworkChange({newCaipNetwork:n,resetSwapState:t,initializeSwapState:o})),v.subscribeChainProp("accountState",n=>{this.onCaipAddressChange({newCaipAddress:n?.caipAddress,resetSwapState:t,initializeSwapState:o})})}}constructor(){super(),this.unsubscribe=[],this.initialParams=$.state.data?.swap,this.detailsOpen=!1,this.caipAddress=v.getAccountData()?.caipAddress,this.caipNetworkId=v.state.activeCaipNetwork?.caipNetworkId,this.initialized=s.state.initialized,this.loadingQuote=s.state.loadingQuote,this.loadingPrices=s.state.loadingPrices,this.loadingTransaction=s.state.loadingTransaction,this.sourceToken=s.state.sourceToken,this.sourceTokenAmount=s.state.sourceTokenAmount,this.sourceTokenPriceInUSD=s.state.sourceTokenPriceInUSD,this.toToken=s.state.toToken,this.toTokenAmount=s.state.toTokenAmount,this.toTokenPriceInUSD=s.state.toTokenPriceInUSD,this.inputError=s.state.inputError,this.fetchError=s.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document?.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{!this.sourceToken||!this.toToken||(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=F.debounce(async()=>{await s.swapTokens()},200),this.subscribe({resetSwapState:!0,initializeSwapState:!1})(),this.unsubscribe.push(this.subscribe({resetSwapState:!1,initializeSwapState:!0}),M.subscribeKey("open",t=>{t||s.resetState()}),$.subscribeKey("view",t=>{t.includes("Swap")||s.resetValues()}),s.subscribe(t=>{this.initialized=t.initialized,this.loadingQuote=t.loadingQuote,this.loadingPrices=t.loadingPrices,this.loadingTransaction=t.loadingTransaction,this.sourceToken=t.sourceToken,this.sourceTokenAmount=t.sourceTokenAmount,this.sourceTokenPriceInUSD=t.sourceTokenPriceInUSD,this.toToken=t.toToken,this.toTokenAmount=t.toTokenAmount,this.toTokenPriceInUSD=t.toTokenPriceInUSD,this.inputError=t.inputError,this.fetchError=t.fetchError,t.sourceToken&&t.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){s.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(t=>t?.()),clearInterval(this.interval),document?.removeEventListener("visibilitychange",this.visibilityChangeHandler)}render(){return c`
    ...
    `}templateTokenInput(t,o){const n=s.state.myTokensWithBalance?.find(u=>u?.address===o?.address),r=t==="toToken"?this.toTokenAmount:this.sourceTokenAmount,i=t==="toToken"?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,a=p.parseLocalStringToNumber(r)*i;return c`<w3m-swap-input
    ...
    ></w3m-swap-input>`}onSetMaxValue(t,o){const n=p.bigNumber(o||"0");if(!n.gt(0)){this.handleChangeAmount(t,"0");return}const r=t==="sourceToken"?this.sourceToken:this.toToken,i=r?.decimals??18,{networkAddress:a}=s.getParams(),u=s.state.gasFee;if(t==="sourceToken"&&r?.address===a&&u&&u!=="0"){const _=150000n*BigInt(u),j=p.bigNumber(_.toString()).div(p.bigNumber(10).pow(i)),L=n.minus(j);this.handleChangeAmount(t,L.gt(0)?L.toFixed(i,0):"0")}else this.handleChangeAmount(t,n.toFixed(i,0))}templateDetails(){return!this.sourceToken||!this.toToken||this.inputError?null:c`<w3m-swap-details .detailsOpen=${this.detailsOpen}></w3m-swap-details>`}handleChangeAmount(t,o){s.clearError(),t==="sourceToken"?s.setSourceTokenAmount(o):s.setToTokenAmount(o),this.onDebouncedGetSwapCalldata()}templateActionButton(){const t=!this.toToken||!this.sourceToken,o=!this.sourceTokenAmount||this.sourceTokenAmount==="0",n=this.loadingQuote||this.loadingPrices||this.loadingTransaction,r=n||t||o||this.inputError;return c` <wui-flex gap="2">
      <wui-button
    ...
    </wui-flex>`}async onSwitchTokens(){await s.switchTokens()}async onSwapPreview(){this.fetchError&&await s.swapTokens(),B.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:this.sourceToken?.symbol||"",swapToToken:this.toToken?.symbol||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:K(v.state.activeChain)===Q.ACCOUNT_TYPES.SMART_ACCOUNT}}),$.push("SwapPreview")}async handleSwapParameters(){this.initialParams&&(s.state.initialized||await new Promise(o=>{const n=s.subscribeKey("initialized",r=>{r&&(n?.(),o())})}),await this.setSwapParameters(this.initialParams))}async setSwapParameters({amount:t,fromToken:o,toToken:n}){(!s.state.tokens||!s.state.myTokensWithBalance)&&await new Promise(a=>{const u=s.subscribeKey("myTokensWithBalance",D=>{D&&D.length>0&&(u?.(),a())});setTimeout(()=>{u?.(),a()},5e3)});const r=[...s.state.tokens||[],...s.state.myTokensWithBalance||[]];if(o){const i=r.find(a=>a.symbol.toLowerCase()===o.toLowerCase());i&&s.setSourceToken(i)}if(n){const i=r.find(a=>a.symbol.toLowerCase()===n.toLowerCase());i&&s.setToToken(i)}t&&!isNaN(Number(t))&&s.setSourceTokenAmount(t)}onCaipAddressChange({newCaipAddress:t,resetSwapState:o,initializeSwapState:n}){this.caipAddress!==t&&(this.caipAddress=t,o&&s.resetState(),n&&s.initializeState())}onCaipNetworkChange({newCaipNetwork:t,resetSwapState:o,initializeSwapState:n}){this.caipNetworkId!==t?.caipNetworkId&&(this.caipNetworkId=t?.caipNetworkId,o&&s.resetState(),n&&s.initializeState())}};d.styles=ee;w([m({type:Object})],d.prototype,"initialParams",void 0);w([l()],d.prototype,"interval",void 0);w([l()],d.prototype,"detailsOpen",void 0);w([l()],d.prototype,"caipAddress",void 0);w([l()],d.prototype,"caipNetworkId",void 0);w([l()],d.prototype,"initialized",void 0);w([l()],d.prototype,"loadingQuote",void 0);w([l()],d.prototype,"loadingPrices",void 0);w([l()],d.prototype,"loadingTransaction",void 0);w([l()],d.prototype,"sourceToken",void 0);w([l()],d.prototype,"sourceTokenAmount",void 0);w([l()],d.prototype,"sourceTokenPriceInUSD",void 0);w([l()],d.prototype,"toToken",void 0);w([l()],d.prototype,"toTokenAmount",void 0);w([l()],d.prototype,"toTokenPriceInUSD",void 0);w([l()],d.prototype,"inputError",void 0);w([l()],d.prototype,"fetchError",void 0);w([l()],d.prototype,"lastTokenPriceUpdate",void 0);d=w([P("w3m-swap-view")],d);const te=I`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`;var ne=function(e,t,o,n){var r=arguments.length,i=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var u=e.length-1;u>=0;u--)(a=e[u])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let R=class extends A{render(){return c`
      <wui-flex alignItems="center">
...
`;var y=function(e,t,o,n){var r=arguments.length,i=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var u=e.length-1;u>=0;u--)(a=e[u])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let b=class extends A{constructor(){super(),this.unsubscribe=[],this.targetToken=$.state.data?.target,this.sourceToken=s.state.sourceToken,this.sourceTokenAmount=s.state.sourceTokenAmount,this.toToken=s.state.toToken,this.myTokensWithBalance=s.state.myTokensWithBalance,this.popularTokens=s.state.popularTokens,this.suggestedTokens=s.state.suggestedTokens,this.tokensLoading=s.state.tokensLoading,this.searchValue="",this.unsubscribe.push(s.subscribe(t=>{this.sourceToken=t.sourceToken,this.toToken=t.toToken,this.myTokensWithBalance=t.myTokensWithBalance,this.popularTokens=t.popularTokens,this.suggestedTokens=t.suggestedTokens,this.tokensLoading=t.tokensLoading}))}async firstUpdated(){await s.getTokenList()}updated(){this.renderRoot?.querySelector(".suggested-tokens-container")?.addEventListener("scroll",this.handleSuggestedTokensScroll.bind(this)),this.renderRoot?.querySelector(".tokens")?.addEventListener("scroll",this.handleTokenListScroll.bind(this))}disconnectedCallback(){super.disconnectedCallback();const t=this.renderRoot?.querySelector(".suggested-tokens-container"),o=this.renderRoot?.querySelector(".tokens");t?.removeEventListener("scroll",this.handleSuggestedTokensScroll.bind(this)),o?.removeEventListener("scroll",this.handleTokenListScroll.bind(this)),clearInterval(this.interval)}render(){return c`
      <wui-flex flexDirection="column" gap="3">
        ${this.templateSearchInput()} ${this.templateSuggestedTokens()} ${this.templateTokens()}
      </wui-flex>
    `}onSelectToken(t){this.targetToken==="sourceToken"?s.setSourceToken(t):(s.setToToken(t),this.sourceToken&&this.sourceTokenAmount&&s.swapTokens()),$.goBack()}templateSearchInput(){return c`
    ...
    `}templateMyTokens(){const t=this.myTokensWithBalance?Object.values(this.myTokensWithBalance):[],o=this.filterTokensWithText(t,this.searchValue);return o?.length>0?c`<wui-flex justifyContent="flex-start" padding="2">
        ...
        ${o.map(n=>{const r=n.symbol===this.sourceToken?.symbol||n.symbol===this.toToken?.symbol;return c`
            <wui-token-list-item
