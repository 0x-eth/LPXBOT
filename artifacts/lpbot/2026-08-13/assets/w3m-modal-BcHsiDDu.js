import{p as v,k as f,l as a,n as d,Q as w,P as M}from"./AppKitProvider-nVcOIkXs.js";import{k as pe,s as me,l as he,p as ve,M as g,S as ee,R as l,h as E,A as j,j as te,i as ie,C as m,m as H,n as fe,o as k,E as G,O as T,q as V,u as F,v as $,x as D,T as ge,y as be,z as ye,B as xe}from"./core-CWWtHjXQ.js";import{c as u,U as Ce}from"./index-Xt1Y6rKv.js";import"./index-D0FmPqGc.js";import"./http-CqmYNlLj.js";import"./parseUnits-CN82zxnQ.js";import"./index.es-kWEtVW6f.js";const p=ve({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(n){return he(p,()=>n(p))},subscribeKey(n,e){return me(p,n,e)},showTooltip({message:n,triggerRect:e,variant:t}){p.open=!0,p.message=n,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
