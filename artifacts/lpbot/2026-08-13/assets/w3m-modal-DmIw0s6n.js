import{$ as x,ao as te,R as c,C as ne,h as g,r as j,j as m,k as b,l as d,n as l,P as k,F as z,Q as u,i as se,y as f,v as D,O as L,af as le,a5 as V,E as U,Y as R,J as F,p as ce,S as A,a1 as T,ac as q,T as de,U as ie,ap as ue,aq as pe}from"./AppKitProvider-nVcOIkXs.js";import{P as _}from"./index-BP7COeHG.js";import{S as he}from"./SwapController-Cnyijf0d.js";import"./index-D0FmPqGc.js";import"./http-CqmYNlLj.js";import"./parseUnits-CN82zxnQ.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
