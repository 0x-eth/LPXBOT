import{p as v,n as c,k as h,l,P as d,Q as u,b as ve,bc as Dt,m as ct,o as ut,an as Bt}from"./AppKitProvider-nVcOIkXs.js";import{j as k,h as R,q as y,x as m,O as U,z as w,E as N,R as W,D as xe,m as E,F as g,G as Ke,B as At,W as He,C as it,n as mt,T as nt,v as je,M as _t,I as It,i as Ut}from"./core-CWWtHjXQ.js";import{c as p,U as Y}from"./index-Xt1Y6rKv.js";import"./index-D0FmPqGc.js";import"./http-CqmYNlLj.js";import"./parseUnits-CN82zxnQ.js";import"./index.es-kWEtVW6f.js";const Nt=v`
  :host {
    position: relative;
...
`;var Lt=function(a,e,i,n){var o=arguments.length,t=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(a,e,i,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(t=(o<3?r(t):o>3?r(e,i,t):r(e,i))||t);return o>3&&t&&Object.defineProperty(e,i,t),t};let Ue=class extends h{constructor(){super(...arguments),this.inputElementRef=ct(),this.checked=void 0}render(){return l`
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("switchChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};Ue.styles=[R,k,Ut,fi];Lt([c({type:Boolean})],Ue.prototype,"checked",void 0);Ue=Lt([p("wui-switch")],Ue);const gi=v`
  :host {
    height: 100%;
  }
