import{y as S,C as g,Y as p,E as c,$ as _,R as s,S as f,z as C,j as u,h as D,k as y,J as d,l as m,Q as E,p as $,m as W,o as P,a0 as N,t as T}from"./AppKitProvider-nVcOIkXs.js";import{W as b}from"./index-DDKpNIvf.js";import"./index-D0FmPqGc.js";import"./http-CqmYNlLj.js";import"./parseUnits-CN82zxnQ.js";var j=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends b{constructor(){super(...arguments),this.onOtpSubmit=async e=>{try{if(this.authConnector){const t=S.state.activeChain,r=g.getConnections(t),n=p.state.remoteFeatures?.multiWallet,i=r.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),t)await g.connectExternal(this.authConnector,t);else throw new Error("Active chain is not set on ChainController");if(p.state.remoteFeatures?.emailCapture)return;if(p.state.siwx){_.close();return}if(i&&n){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(t){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(t)}}),t}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=j([u("w3m-email-verify-otp-view")],I);const F=D`
  wui-icon-box {
