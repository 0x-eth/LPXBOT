...
describe("P01 complete PostgreSQL migration cycle", () => {
  it("runs every migration up, all downs in reverse, then every up and repeatable seed", async () => {
    ...
    expect(await publicTables()).toEqual([
      ...
      "chain_operation_audit_events",
      "chain_operation_idempotency",
      "chain_operation_outbox",
      "chain_operation_receipt_evidence",
      "chain_operation_reconciliation_cases",
      "chain_operation_replacement_authorizations",
      "chain_operation_transactions",
      "chain_operations",
      ...
      "local_helper_upgrade_audit_events",
      "local_helper_upgrade_deployment_receipt_evidence",
      "local_helper_upgrade_final_rescan_evidence",
      "local_helper_upgrade_operations",
      "local_helper_upgrade_outbox",
      "local_helper_upgrade_previews",
      "local_helper_upgrade_replacement_authorizations",
      "local_helper_upgrade_steps",
      "local_helper_upgrade_transactions",
      "local_helper_upgrade_v2_verification_evidence",
      ...
      "wallet_helper_deployment_bindings",
