...
test("PostgreSQL exposes TimescaleDB, pgcrypto, and migration history", () => {
  ...
  assert.equal(
    ...
    "access_audit_events,address_remark_audit_events,address_remarks,app_metadata,auth_login_wallets,auth_wallet_challenges,canonical_chain_blocks,chain_access_management_audit_events,chain_access_policies,chain_access_policy_history,indexer_cursors,integrity_quarantine,liquidity_flow_events,liquidity_flow_outbox,market_candles,market_pool_catalog,market_read_model_states,market_snapshots,market_stream_outbox,market_tick_liquidity,monitor_candidate_suppressions,monitor_candidates,monitor_create_idempotency,monitor_evaluation_watermarks,monitor_notification_destination_bindings,monitors,normalized_pool_events,notification_destination_create_idempotency,notification_destination_versions,notification_destinations,notification_outbox,notification_preferences,pool_creation_provenance,pool_creation_provenance_conflicts,pool_creator_query_audit_events,raw_chain_logs,schema_migrations,sessions,task_status_stats_conflicts,task_status_stats_projection_state,task_status_stats_query_audit_events,task_status_stats_stream_heads,task_status_stats_user_snapshots,telegram_bot_login_intents,telegram_identities,telegram_init_data_replays,user_pool_blocklist_entries,user_pool_blocklist_state,user_preferences,users",
  );
});
